...
class InternalMethodsTests(unittest.TestCase):
    ...
    def test_state_diagram(self):
        TorState(FakeControlProtocol(),
                 bootstrap=False,
                 write_state_diagram=True)
...
class BootstrapTests(unittest.TestCase):
    ...
    def test_build_unix_wrong_permissions(self):
        self.assertRaises(
            ValueError, build_tor_connection,
...
class StateTests(unittest.TestCase):
    ...
    def test_bootstrap_callback(self):
        ...
        fakerouter = object()
        self.state.routers['$0000000000000000000000000000000000000000'
                          ] = fakerouter
        self.state.routers['$9999999999999999999999999999999999999999'
                          ] = fakerouter
        ...
        self.assertTrue('$0000000000000000000000000000000000000000' in
                        self.state.entry_guards)
        self.assertEqual(
            self.state.entry_guards['$0000000000000000000000000000000000000000'
                                                ], fakerouter)
    ...
    def test_close_stream_invalid_reason(self):
        ...
        self.state.streams[1] = stream
        self.assertRaises(
            ValueError, self.state.close_stream, stream, 'FOO_INVALID_REASON')
...
'''.split('\n')))
        ...
        self.assertTrue('$00126582E505CF596F412D23ABC9E14DD4625C49' in
                        self.state.routers)
