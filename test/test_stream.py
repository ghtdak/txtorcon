...
class StreamTests(unittest.TestCase):
    ...
    def test_magic_circuit_detach(self):
        ...
        stream.update(
            "1 SENTCONNECT 0 94.23.164.42.$43ED8310EB968746970896E8835C2F1991E50B69.exit:9001 SOURCE_ADDR=(Tor_internal):0 PURPOSE=DIR_FETCH".split(
            ))
    ...
    def test_update_illegal_state(self):
        ...
        try:
            stream.update(
                "316 FOO 0 www.yahoo.com:80 SOURCE_ADDR=127.0.0.1:55877 PURPOSE=USER".split(
                ))
            self.fail()
        except Exception, e:
    ...
    def test_stream_changed(self):
        ...
        listener = Listener([(
            'new', {'target_host': 'www.yahoo.com',
                    'target_port': 80}), ('attach', {}), ('succeeded', {})])
    ...
    def test_stream_changed_with_detach(self):
        ...
        stream.listen(listener)
        stream.update(
            "999 NEW 0 www.yahoo.com:80 SOURCE_ADDR=127.0.0.1:55877 PURPOSE=USER".split(
            ))
    ...
    def test_listener_fail(self):
        ...
        stream.update("316 REMAP 186 1.2.3.4:80 SOURCE=EXIT".split())
        stream.update(
            "316 FAILED 0 1.2.3.4:80 REASON=TIMEOUT REMOTE_REASON=DESTROYED".split(
            ))
    ...
    def test_states_and_uris(self):
        ...
        for address in [
            ...
            for state in ['NEW', 'SUCCEEDED', 'REMAP', 'SENTCONNECT',
                          'DETACHED', 'NEWRESOLVE', 'SENTRESOLVE', 'FAILED',
                          'CLOSED']:
