...
class EndpointTests(unittest.TestCase):
    ...
    def test_global_tor_error(self):
        ...
        try:
            config2 = yield get_global_tor(Mock(),
                                           socks_port=4321,
                                           _tor_launcher=lambda x, y, z: True)
            self.fail()
        ...
        try:
            config3 = yield get_global_tor(Mock(),
                                           control_port=111,
                                           _tor_launcher=lambda x, y, z: True)
            self.fail()
        except RuntimeError as e:
    ...
    def test_parse_via_plugin(self):
        ...
        ep = serverFromString(
            self.reactor,
            'onion:88:localPort=1234:socksPort=9998:hiddenServiceDir=/foo/bar')
...
class EndpointLaunchTests(unittest.TestCase):
    ...
    def test_endpoint_connect_tor(self, private_tor, global_tor, system_tor):
        ...
        ep = serverFromString(
            reactor,
            'onion:8888:controlPort=9055:localPort=1234:socksPort=9997')
        r = yield ep.listen(NoOpProtocolFactory())
