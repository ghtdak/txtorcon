...
class CreateTorrcTests(unittest.TestCase):
    ...
    def test_create_torrc(self):
        ...
        config.hiddenservices = [HiddenService(
            config, '/some/dir', '80 127.0.0.1:1234', 'auth', 2, True)]
...
HiddenServiceAuthorizeClient Dependant''')
    ...
    def test_options_hidden(self):
        ...
        conf.hiddenservices.append(HiddenService(
            conf, '/some/dir', '80 127.0.0.1:2345', 'auth', 2, True))
...
class FakeProcessTransport(proto_helpers.StringTransportWithDisconnection):
    ...
    def signalProcess(self, signame):
        self.process_protocol.processEnded(Failure(error.ProcessTerminated(
            signal=signame)))
...
class LaunchTorTests(unittest.TestCase):
    ...
    def test_launch_root_changes_tmpdir_ownership(self, chown, euid, _pwd,
                                                  _sys):
