...
class TCPHiddenServiceEndpoint(object):
    ...
    def _update_onion(self, thedir):
        ...
        try:
            ...
            self.onion_uri = None
            txtorlog.msg(RuntimeError("Can't read hostname from \"%s\": %s" % (
                hn, str(e))))
        ...
        try:
            ...
            self.onion_private_key = None
            txtorlog.msg(RuntimeError("Can't read private key from \"%s\": %s" %
                                      (pk, str(e))))
    ...
    def _create_listener(self, proto):
        ...
        self.tcp_endpoint = self.endpoint_generator(self.reactor,
                                                    self.listen_port)
