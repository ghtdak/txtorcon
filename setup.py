...
setup(
    ...
    requires=['twisted (>10.1.0)', 'GeoIP', 'ipaddr'],
    classifiers=
    ['Framework :: Twisted', 'License :: OSI Approved :: MIT License',
     'Natural Language :: English', 'Operating System :: POSIX :: Linux',
     'Operating System :: Unix', 'Programming Language :: Python',
     'Topic :: Internet :: Proxy Servers', 'Topic :: Internet',
     'Topic :: Security'],
    author=__author__,
    ...
    data_files
    =[('share/txtorcon', ['INSTALL', 'README', 'TODO', 'meejah.asc']),
      ## this includes pre-built single-page HTML docs
      ## into the distribution. the map construct grabs
      ## everything in doc_html/_static
      ('share/txtorcon', ['doc_html/index.html', 'doc_html/objects.inv'] + map(
          lambda x: os.path.join('doc_html/_static', x), os.listdir(
              'doc_html/_static'))),
